...
<div class="viz-slide">
  ...
  <div class="viz-shot">
  <img :src="`${$slidev.configs.base || '/vue-conf-26-slides/'}screenshots/agents-expanded.png`" alt="harness-visualizer showing the agents view with claude-code expanded" />
</div>
</div>
...
<div class="lenses-slide">
  ...
  <div class="lenses-stage">
    <div class="lens-shot" v-show="$clicks === 0">
      <img :src="`${$slidev.configs.base || '/vue-conf-26-slides/'}screenshots/agents-view.png`" alt="Agents view" />
    ...
    <div class="lens-shot" v-show="$clicks === 1">
      <img :src="`${$slidev.configs.base || '/vue-conf-26-slides/'}screenshots/issues-view.png`" alt="Issues view" />
    ...
    <div class="lens-shot" v-show="$clicks === 2">
      <img :src="`${$slidev.configs.base || '/vue-conf-26-slides/'}screenshots/table-view.png`" alt="Table view" />
...
<div class="qr-slide">
  ...
  <div class="qr-content">
    <div class="qr-card">
      <img :src="`${$slidev.configs.base || '/vue-conf-26-slides/'}repo-qr.png`" alt="QR code linking to the harness-visualizer GitHub repo" />
    </div>
    <div class="qr-info">
...
<div class="thanks-slide">
  ...
  <div class="thanks-linkedin">
    <img :src="`${$slidev.configs.base || '/vue-conf-26-slides/'}linkedin-qr.png`" alt="QR code linking to Will Marple's LinkedIn profile" />
  </div>
